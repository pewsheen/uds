export type CaptionTrackRaw = { baseUrl: string; languageCode: string; name?: { simpleText?: string }; kind?: string }
...
export type CaptionMeta = { languageCode?: string; videoId?: string | null; asr?: boolean }
export type CaptionMsg = { __dualSubsCaption: true; url: string; body: string } & CaptionMeta
export type LoadRequest = { languageCode?: string; asr?: boolean }
export type BridgeMessage = { __dualSubsReady?: boolean; __dualSubsLoad?: LoadRequest }
